...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">
            ...
            <div class="card p-0 mt-3">
                <div class="card-header bg-dark text-white">
                    <h4 class="h4">Edit Task #{{ $task->id }}</h4>
                </div>
    ...
    <div class="mb-3">
        ...
        <input value="{{ old('title', $task->title) }}"  class="form-control  @error('title') is-invalid @enderror" type="text" name="title" placeholder="Enter title">
        @error('title')
    ...
    <div class="mb-3">
        ...
        <input value="{{ old('due_date', $task->due_date) }}" type="date" name="due_date" class="form-control @error('due_date') is-invalid @enderror">
          @error('due_date')
            <p class="invalid-feedback">{{ $message }}</p>
        @enderror
    </div>
